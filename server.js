...
function buildDoc(children) {
  return new Document({ styles:{default:{document:{run:{font:TNR,size:FS}}}},
    sections:[{ properties:{page:{size:{width:12240,height:15840},margin:{top:1080,right:1080,bottom:1080,left:1260}}}, children }] });
}
...
function makeRequestLetter(D) {
  ...
  return buildDoc([
    ...
    P([R("Dear Sir,")]),
    ...SP(),
    P([R("With respect to above mentioned subject, I/We request you to give On Demand bill of exchange discounting facility for "),BU(fmtRs(D.loan.boeAmount)+" ("+toWords(D.loan.boeAmount)+")"),R(" for which I/We will raise an on Demand Bill of Exchange in your favor. I/We are also ready to give On Demand bill of exchange discounting charges flat @ "),B(D.loan.ratePercent.toFixed(2)+"%"),R(" p.m. for a period of "),B(D.loan.tenureMonths+" Months"),R(". In order to simplify the repayment for us/me, you are requested to grant us the facility to repay the amount in installments. The cost of it if any will be borne by us.")]),
    ...SP(),
    P([R("I/We hereby agree to submit to you all the relevant documents including Repayment cheques, on Demand Bill of exchange, confirmation & undertaking, PDC's, Board resolution (if applicable), personal details & other relevant documents immediately on availing the On Demand Bill of Exchange Discounting Facility.")]),
    ...SP(),
    P([R("I/We have no objection in you obtaining information about our entity and its members from any Credit Rating Agencies and also authorize you to share details relating to this transaction with any Credit Rating Agencies.")]),
    ...SP(),
    P([R("I/We assure you that we will not make any default in payments and in case it happens we hereby also agree to pay you the cheque Dishonor charges of Rs.5000/- per instance and additional 5% penal charges per month of the unpaid / dishonored cheque amount towards delayed payment for number of days till the payment is cleared.")]),
    ...SP(),
    P([R("We hereby request you to consider our request and oblige.")]),
    ...SP(),
    P([R("Thanking You,")],{after:40}),P([R("Yours Faithfully")]),
    ...SP(2),
    P([R("For "),B(D.company.name+" ")],{after:160}),
    ...SP(),
    P([B("  "+dirSig)],{after:80}),
    P([R("Photo with cross  sign")],{after:160}),
  ]);
}
...
function makePersonalUndertaking(D, director) {
  return buildDoc([
    P([R("From,")],{after:40}),
    P([B(director.name)],{after:40}),
    ...director.address.map(l=>P([R(l)],{after:40})),
    ...SP(),
    ...
    P([R("This is to confirm that I/We "),B(director.name),R(" in my personal capacity hereby admit my signature on bill of exchange dated "),B(D.loan.disbursementDate),R(". I/We have signed as an acceptor in the On Demand Bill of Exchange under my personal capacity. ")]),
    ...SP(),
    P([R("I/We hereby say that I/We am aware "),B("      "+D.company.name+"      "),R("has drawn the aforesaid bill of exchange in favour of "),B(D.lender.name),R(". I/We am aware that "),BU(fmtRs(D.loan.boeAmount)+" ("+toWords(D.loan.boeAmount)+")"),R(" is received by "),B("  "+D.company.name+"  "),R(" vide RTGS No/ Cheque No. "),B(D.loan.rtgsNo+" "),R("dated "),B(D.loan.disbursementDate),R(" after deducting bill of exchange discounting charges of "),BU(fmtRs(D.loan.interestAmount)+"/- ("+toWords(D.loan.interestAmount)+") "),R("The said amount is advanced for the period of "),B(D.loan.tenureMonths+" Months"),R(". And against which bill of exchange discounting charges are deducted upfront @ "+D.loan.ratePercent.toFixed(2)+"% p.m. ")]),
    ...SP(),
    P([R("I hereby state that the drawee of the on demand bill of exchange can exercise his powers to demand the entire amount and on demand bill of exchange discounting charges along with penal/overdue charges, cheque bounce charges and visit charges")]),
    ...SP(),
    P([R("I say that "),B(D.company.name),R(" is liable to repay the "),BU(fmtRs(D.loan.boeAmount)+" ("+toWords(D.loan.boeAmount)+") "),R("Within "),B(D.loan.tenureMonths+" Months"),R(" if he fails to pay so, then in such case I will personally repay the outstanding dues and overdue charges @ 5% p.m immediately, in case of any cheque bounce Rs. 5000/- towards cheque bounce charges.")]),
    ...SP(),
    P([R("I state that I have signed and issued a cheque in your favor bearing no ________________________Bank,____________, Branch, in discharge of my liability. In case of default/delay in payment by "),B(D.company.name),R(" the said cheque can be utilized by you after filling in the amount to recover outstanding principle amount and outstanding overdue charges (if any).")]),
    ...SP(),
    P([R("In case of any default "),B(D.lender.name+" "),R("in person or through its representative will have right to call for the entire outstanding dues, overdue charges (if any), visit charges, cheque bounce charges, or any other charges. Also, that "),B(D.lender.name+" "),R("will have authority to forfeit the entire on demand bill of exchange discounting charges.")]),
    ...SP(),
    ...
    ...SP(),
    P([R("In case of any delay in making payment the drawee of the bill of exchange will hold rights to recover entire advanced amount along with overdue/ penal charges @ 5% p.m in the foregoing month. ")]),
    ...SP(),
    P([R("In case of any default by the drawer or me I give you to approach me anytime over a phone call, by visiting to my residence/office/native place or any other place as and when required. I also state that you will be at liberty to do such an act in person or through your representatives. I further state that the "),B(D.lender.name+" "),R("in person or through its representatives can make such visits at any time in day and night and I shall never claim the same to be against law or nature on human grounds or any other grounds. ")]),
    ...SP(),
    P([R("In case of failure in making payment the drawee of the bill of exchange can take any legal action against me/us as may be prescribed in the law that the drawee of the on demand bill of exchange can also come personally or through its representative to my residence/native/office or any other address as and when required for any verification, collection of money or any other activity required for recovery of the sum advanced, on demand bill of exchange discounting charges/overdue charges/penalty/or any other charges as and when required during any time throughout the day or night, during weekdays, holidays or weekends without any further written or oral consent. The drawee shall have right to demand the outstanding dues after or at the time of default in repayment or at any other time as he may deem fit. ")]),
    ...SP(),
    P([R("In case of any default or dispute between the parties the matter may be referred to the arbitration to resolve the dispute under Arbitration and Conciliation Act, 2019, As (amended). All disputes will be subject to Mumbai jurisdiction only. And if the "),B(D.lender.name+" "),R("feels that the company is not in sound position or there is a need to initiate proceedings for Insolvency and Bankruptcy they may proceed without any intimation or doubt and in such case matter will not be referred before the arbitrator. And the same will not be disputed by us before any court or competent authorities.")]),
    ...SP(),
    ...
    ...SP(),
    P([R("Thanking You,"),R("Sincerely Yours")],{after:80}),
    ...SP(),
...
function makeCompanyUndertaking(D) {
  ...
  return buildDoc([
    ...
    P([R("This is to confirm that, "),B("  "+D.company.name+"  "),R("have availed on Demand bill of exchange discounting facility of "),BU(fmtRs(D.loan.boeAmount)+" ("+toWords(D.loan.boeAmount)+") "),R("from you for business requirements.")]),
    ...SP(),
    P([R("The sum of "),BU(fmtRs(D.loan.interestAmount)+"- ("+toWords(D.loan.interestAmount)+")"),R(" has been deducted towards bill of exchange discounting charges @ "),B(D.loan.ratePercent.toFixed(2)+"% pm"),R(" for the said period of "),B(D.loan.tenureMonths+" Months"),R(".")]),
    ...SP(),
    T([
    ...
    ],[1680,1440,1680,1080,1440,2040]),
    ...SP(),
    P([R("I/we further confirm and state that I/we have issued cheques from A/c. No __________________________ Bank, ________________________________ Branch. voluntarily after having fully understood its legal implications as follows:")]),
    ...SP(),
    T([
    ...
    ...SP(),
    P([R("Towards re-payment of amount advanced to us in the form of bill of exchange document, I/ we hereby irrevocably confirm that the aforesaid amount is outstanding, and I/ we further solemnly assure you that:")]),
    ...SP(),
    ...
    ...SP(),
    P([R("In case of dishonor of any cheque/s issued by us, we hereby agree to pay you the cheque bouncing charges of Rs.5000/- per instance and additional 5% penal charges per month of the unpaid / dishonored cheque amount towards delayed payment for number of days till the payment is cleared. In case of any default in any kind of repayments from our side we give full authority to you and your representatives to visit our premises (Office / Residence / Natives) for collection of dues and we agree to pay you Rs.5000/- per visit as visiting charges. We also agree to pay all legal / follow up / collection expenses to you in case such a situation arises. In case of any delay in making payment the drawee of the On demand Bill of Exchange will hold rights to recover entire advanced amount along with overdue/ penal charges @ 5% p.m.")]),
    ...SP(),
    P([R("I/we state that my staff or my family member i.e wife, children or any other person shall not initiate any civil and criminal action against you or your representative if they visit to my office or house for demanding outstanding amount and if someone do so I will be responsible for that and you can file complain against me for breach of terms & conditions as mentioned herein and for cheating, default or fraud if any from your side. This is as we had mutually agreed that in case of default you or your representatives can attend any place office/residence/native place/ relatives house or where the drawee feels fit to approach for repayments. I further state that "),B(D.lender.name+"  "),R("in person or through its representatives can make such visits at any time in day and night and I shall never claim the same to be against law or nature on human grounds or any other grounds.  ")]),
    ...SP(),
    P([R("We are also aware that in the event of any default in honoring the cheques, you are at liberty to take action against us under Section 138 of negotiable instrument act and / or any other legal action pertaining to the above matter including under section 420, 120(b), 406,407 of Indian Penal Code or any other such civil or criminal remedy available in the court of law. We shall be fully responsible for the expenditure of the same.")]),
    ...SP(),
    P([R("In case of any default or dispute the Drawee of Bill of Exchange will have exclusive rights to appoint a sole arbitrator of its own choice and the Drawer or acceptor will not dispute the same. All the parties will deposit the fees of the arbitrator with the arbitrator and the party in whose favor the decree is being passed will withdraw the deposited amount of fees and the other parties will have to bear the expenses and costs involved in the transaction.  ")]),
    ...SP(),
    P([R("This undertaking is valid and shall hold good till the repayment of the said facility with charges and penal / overdue charges (if any) is done completely.")]),
    ...SP(),
    P([R("All disputes will be subject to Mumbai jurisdiction only. ")]),
    ...SP(),
    P([R("Thanking You,")],{after:40}),P([R("Yours Faithfully")]),
    ...SP(),
...
async function makeBillOfExchange(D, outDir) {
  ...
  const fp=path.join(outDir,"4-Bill_of_Exchange.xlsx");
...
async function makePromissoryNote(D, outDir) {
  ...
  const fp=path.join(outDir,"10-Promissory_Note.xlsx");
  await wb.xlsx.writeFile(fp);
}
...
app.post('/generate', async (req, res) => {
  try {
    ...
    // DOCX docs
    const docxList = [
      {name:'1-Request_Letter',      doc: makeRequestLetter(D)},
      {name:'2-Authority_Letter',    doc: makeAuthorityLetter(D)},
      {name:'3-Receipt',             doc: makeReceipt(D)},
      {name:'5-Board_Resolution',    doc: makeBoardResolution(D)},
      {name:'9-Company_Undertaking', doc: makeCompanyUndertaking(D)},
      ...D.directors.map((dir,i)=>({
        name:`${6+i}-Conf_Undertaking_${dir.name.replace(/ /g,'_')}`,
        doc: makePersonalUndertaking(D, dir)
      })),
    ];
    ...
    // XLSX docs
    await makeBillOfExchange(D, outDir);
    await makePromissoryNote(D, outDir);

    // ZIP everything
    res.setHeader('Content-Type','application/zip');
    res.setHeader('Content-Disposition',`attachment; filename="BoE_${D.company.name.split(' ').slice(0,3).join('_')}.zip"`);
    const archive = archiver('zip');
    archive.pipe(res);
    archive.directory(outDir, false);
    archive.finalize();
    archive.on('end', ()=>{ try{fs.rmSync(outDir,{recursive:true});}catch(e){} });
  } catch(e) {
    console.error(e);
...
app.listen(3000, ()=>console.log('✅  Parshwa Capital BoE Generator running at http://localhost:3000'));
